...
public class TwoFactorAuthenticationCWActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aadhaarCard = sharedPreferences.getString("adharcard", null); // added by shuaib 4 - 4- 24
...
//        }
    ...
    private void doAepsAuthentication() {
        ...
        if(title.equalsIgnoreCase("TwoFactorAuth")){
            ...
            call = RetrofitClient.getInstance().getApi().twoFactorCWBank(AUTH_KEY,userId,deviceId,deviceInfo,pidData,
                    lat,longi);
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            new AlertDialog.Builder(TwoFactorAuthenticationCWActivity.this)
                                    ...
                                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            //  finish();
                                            startActivity(new Intent(TwoFactorAuthenticationCWActivity.this , HomeDashActivity.class));
                                        }
                                    }).show();
                        }
                        else {
