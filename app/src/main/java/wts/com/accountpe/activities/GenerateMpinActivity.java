...
*/
 ...
 //_________________________________________________________________________
        ...
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(GenerateMpinActivity.this);
...
//        mobileno = sharedPreferences.getString("mobileno", null);
    ...
    private void checkOtp() {
        ...
        final android.app.AlertDialog progressDialog = new android.app.AlertDialog.Builder(GenerateMpinActivity.this).create();
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            new AlertDialog.Builder(GenerateMpinActivity.this).setTitle(dialogTitle)
                            ...
                            new AlertDialog.Builder(GenerateMpinActivity.this).setTitle("Alert")
                                    .setMessage("Something went wrong")
