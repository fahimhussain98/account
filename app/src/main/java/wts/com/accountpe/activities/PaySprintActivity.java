...
public class PaySprintActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pay_sprint);
        ...
        window.setStatusBarColor(ContextCompat.getColor(PaySprintActivity.this, R.color.purple_700));
        //////CHANGE COLOR OF STATUS BAR///////////////

        //////////////////////////////////////////////////////////////////

        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(PaySprintActivity.this);
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(PaySprintActivity.this);
        getBankList();
    ...
    private void getBankList() {
        ProgressDialog progressDialog = new ProgressDialog(PaySprintActivity.this);
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            tvBankName.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    SpinnerDialog bankDialog = new SpinnerDialog(PaySprintActivity.this, bankNameArrayList, "Select Bank", R.style.DialogAnimations_SmileWindow, "Close  ");// With 	Animation
                            ...
                            progressDialog.dismiss();
                            new androidx.appcompat.app.AlertDialog.Builder(PaySprintActivity.this)
                                    .setCancelable(false)
    ...
    private void showMessageDialog(String message) {
        final AlertDialog messageDialog = new AlertDialog.Builder(PaySprintActivity.this).create();
        final LayoutInflater inflater = LayoutInflater.from(PaySprintActivity.this);
    ...
    private void getLastLocation() {
        if (checkPermissions()) {
            if (isLocationEnabled()) {
                ...
                Toast.makeText(PaySprintActivity.this, "Turn on location", Toast.LENGTH_LONG).show();
    ...
    private boolean checkPermissions() {
        return ActivityCompat.checkSelfPermission(PaySprintActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED &&
                ActivityCompat.checkSelfPermission(PaySprintActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED;
    }

    private void requestPermissions() {
        ActivityCompat.requestPermissions(PaySprintActivity.this,
    ...
    private void doAePSTransaction() {
        ...
        Call<JsonObject> call = RetrofitClient.getInstance().getApi().doAepsTransaction(AUTH_KEY, userId, aadharNo, selectedBankIIN, amount,
                selectedTransactionType, pidData, lat, longi, mobileNo, selectedBankName, deviceId, deviceInfo);
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            for (int i = 0; i < transactionArray.length(); i++) {
                                ...
                                if (transactionType.equalsIgnoreCase("MINI STATEMENT")) {
                                    ...
                                    Intent intent = new Intent(PaySprintActivity.this, MiniStatementSecondPaySprintActivity.class);
                                    ...
                                    String accountBalance = transactionObject.getString("accountBalance");
                                    Intent intent = new Intent(PaySprintActivity.this, AepsTransactionSecondActivity.class);
                                    intent.putExtra("transactionType", transactionType);
                                    intent.putExtra("bankName", bankName);
                                    intent.putExtra("responseMobileNumber", responseMobileNumber);
                                    intent.putExtra("responseAadharNumber", responseAadharNumber);
