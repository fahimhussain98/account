...
//        tvBalance.setText("₹ " + balance);
    ...
    private void doAepsTransaction() {
        ...
        Call<JsonObject> call = RetrofitClient.getInstance().getApi().doAepsTransactionCredo(AUTH_KEY, userId, aadharNo, selectedBankIIN, amount,
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            for (int i = 0; i < transactionArray.length(); i++) {
                                ...
                                if (transactionType.equalsIgnoreCase("MINI STATEMENT")) {
                                    ...
                                    Intent intent = new Intent(PaySprintActivityBank2.this, MiniStatementSecondPaySprintActivity.class);
                                 ...
                                 //   Intent intent = new Intent(PaySprintActivityBank2.this, AepsTransactionActivityBankwise.class);
                                    // for virddhi printer
                                      Intent intent = new Intent(PaySprintActivityBank2.this, AepsTransactionSecondActivity.class);
                                    intent.putExtra("transactionType", transactionType);
                                    intent.putExtra("bankName", bankName);
                                    intent.putExtra("responseMobileNumber", responseMobileNumber);
                                    intent.putExtra("responseAadharNumber", responseAadharNumber);
