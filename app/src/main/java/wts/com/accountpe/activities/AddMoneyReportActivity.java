...
import wts.com.accountpe.adapters.AddMoneyReportAdapter;
...
public class AddMoneyReportActivity extends AppCompatActivity {
    ...
    private void getAddMoneyReport(String fDate, String tDate, String searchBy) {
        ...
        final android.app.AlertDialog pDialog = new android.app.AlertDialog.Builder(AddMoneyReportActivity.this).create();
      ...
      //  Call<JsonObject> call = RetrofitClient.getInstance().getApi().getAddMoneyReport(AUTH_KEY, userId, deviceId, deviceInfo,  fDate, tDate);  // free bali add money
        Call<JsonObject> call = RetrofitClient.getInstance().getApi().upigatewayreport(AUTH_KEY, userId, deviceId, deviceInfo,  fDate, tDate, searchBy);  // Mrobotics add money report
                    ...
                    try {
                        ...
                        if (response_code.equalsIgnoreCase("TXN")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                               ...
                               // name = jsonObject.getString("Name");  // for free bali
                              ...
                              //  dateTime = jsonObject.getString("CreatedOn");  // for free bali
